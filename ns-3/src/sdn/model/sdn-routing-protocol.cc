...
RoutingProtocol::RoutingProtocol ()
  :
    ...
    m_rmInterval (Seconds (3)),//√ø∏ˆlc—°≥µµƒ÷‹∆⁄
    m_minAPInterval (Seconds (1)),//√ª”√µΩ
    m_ipv4 (0),
...
typedef struct Edge
{
    int u, v;    // Ëµ∑ÁÇπÔºåÈáçÁÇπ
    int weight;  // ËæπÁöÑÊùÉÂÄº
} Edge;
...
/*std::cout<<"RemoveTimeOut"<<std::endl;
    ...
    Edge edge[max_car_number*max_car_number];     // ‰øùÂ≠òËæπÁöÑÂÄº
